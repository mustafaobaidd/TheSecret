        ...
        sharedImages.forEach((image, index) => {
                    ...
                    <div class="card Featured__card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" id="description-${index}">
                                ${image.description.length > 20 ? image.description.substring(0, 20) + '... <a href="open/Quick_Vegetarian-login_open.html" onclick="showMore(${index})">see more</a>' : image.description}
                            </p>
           ...
           `;
            ...
            window.openImage = function(index) {
                ...
                window.location.href = 'open/Quick_Vegetarian-login_open.html';
            }
        });
    } else {
